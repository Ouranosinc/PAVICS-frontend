...
import OLRegionsBBoxSelector from './../../containers/OLRegionsBBoxSelector';
import OLRegionsClickSelector from './../../containers/OLRegionsClickSelector';
...
const { Provider: MapProvider} = React.createContext();
