      ...
      <div ref={this.setWrapperRef}>
        <SpeedDial
          ...
          <SpeedDialAction
            ...
            onClick={(event) => this.props.toggleWidget(constants.WIDGET_LAYER_SWITCHER_KEY)}
            ButtonProps={{
          ...
          <SpeedDialAction
            ...
            onClick={(event) => this.props.toggleWidget(constants.WIDGET_MAP_CONTROLS_KEY)}
            ButtonProps={{
          ...
          <SpeedDialAction
            ...
            onClick={(event) => this.props.toggleWidget(constants.WIDGET_TIME_SLIDER_KEY)}
            ButtonProps={{
          ...
          <SpeedDialAction
            ...
            onClick={(event) => this.props.toggleWidget(constants.WIDGET_CHART_KEY)}
            ButtonProps={{
          ...
          <SpeedDialAction
            ...
            onClick={(event) => this.props.toggleWidget(constants.WIDGET_INFO_KEY)}
            ButtonProps={{
          ...
          <SpeedDialAction
            ...
            onClick={(event) => this.props.toggleWidget(constants.WIDGET_CUSTOM_REGIONS_KEY)}
            ButtonProps={{
