...
if(0) {
  ...
  (function () {
    ...
    wpsObj.Class = function () {
    };

    // Create a new Class that inherits from this class
    wpsObj.Class.extend = function (prop) {
      var _super = this.prototype;
...
var BaseResponse = wpsObj.Class.extend({
...
var ResponseFactory = wpsObj.Class.extend({
...
var BaseRequest = wpsObj.Class.extend({
	init : function(settings) {
		this.settings = settings;
 ...
 * and 2.0
 */
var OutputGenerator = wpsObj.Class.extend({
	/**
	 *
	 */
	init : function(settings) {
 ...
 */
var WpsService = wpsObj.Class.extend({
