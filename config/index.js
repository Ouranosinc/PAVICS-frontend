...
const config = {
  ...
  pavics_solr_path: process.env.PAVICS_SOLR_PATH || 'http://132.217.140.45:8091',
  pavics_pywps_path: 'http://132.217.140.45:8086/pywps?service=WPS&request=execute&version=1.0.0&identifier=pavicsearch&DataInputs=',
